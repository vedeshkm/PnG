...
WebUI.verifyElementPresent(findTestObject('OMVA_Landing_Page/SummaryLogo_ASpoc'), 5)

WebUI.verifyElementPresent(findTestObject('OMVA_Landing_Page/History_Logo'), 5)

WebUI.verifyElementNotPresent(findTestObject('OMVA_Landing_Page/Workbench_Logo'), 5)
