...
ChanMSP_WB_Count = CustomKeywords.'applicationLibrary.GetsPendingTaskCount_WBScreen.Get_PendingTask_Count_WBscreen'()
...
ChanMSP_S_Count = CustomKeywords.'applicationLibrary.GetsPendingTaskCount_ChanMSP_SummaryScreen.Get_ChanMSPPendingTask_Count_Summaryscreen'()

WebUI.verifyEqual(ChanMSP_WB_Count, ChanMSP_S_Count)
