...
ActualEmailErrorMsg = WebUI.getText(findTestObject('OMVA_UserManagement_Page/EmailID_Error_Msg'))

WebUI.verifyMatch(ActualEmailErrorMsg, findTestData('CreateUser').getValue('MendatoryMsge', 5), true)
