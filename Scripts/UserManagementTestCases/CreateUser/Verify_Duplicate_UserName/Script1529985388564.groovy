...
ActualToastMessage = WebUI.getText(findTestObject('OMVA_UserManagement_Page/Username_toastMsg'))

println(ActualToastMessage)

WebUI.verifyMatch(ActualToastMessage, findTestData('CreateUser').getValue('ExpUNToast', 1), true)
