...
ActualFirstNameErrorMsg = WebUI.getText(findTestObject('OMVA_UserManagement_Page/FirstName_Error_msg'))

WebUI.verifyMatch(ActualFirstNameErrorMsg, findTestData('CreateUser').getValue('MendatoryMsge', 6), true)
