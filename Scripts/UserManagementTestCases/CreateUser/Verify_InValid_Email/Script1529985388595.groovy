...
ActualInvalidMsg = WebUI.getText(findTestObject('OMVA_UserManagement_Page/Email_Invalid_Msg'))

WebUI.verifyMatch(ActualInvalidMsg, findTestData('credentialDetails/CreateUser').getValue('MendatoryMsge', 4), true)
