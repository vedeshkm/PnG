...
createduser = WebUI.verifyMatch(createduser, (firstname + ' ') + lastname, true)
...
WebUI.waitForElementVisible(findTestObject('OMVA_Landing_Page/Edit_icon'), 7)

WebUI.click(findTestObject('OMVA_Landing_Page/Edit_icon'))

WebUI.waitForElementVisible(findTestObject('OMVA_EditUser_Page/EditUserFirstName'), 7)

WebUI.sendKeys(findTestObject('OMVA_EditUser_Page/EditUserFirstName'), findTestData('credentialDetails/Credentials_IDPwd').getValue(
        'InvalidID', 1))

WebUI.waitForElementVisible(findTestObject('OMVA_EditUser_Page/EditUserNext_Btn'), 7)

WebUI.click(findTestObject('OMVA_EditUser_Page/EditUserNext_Btn'))

WebUI.verifyElementText(findTestObject('OMVA_EditUser_Page/UpdateSucessful_ToastMessage'), findTestData('credentialDetails/CreateUser').getValue(
        'UpdateSucessToastMessage', 1), FailureHandling.STOP_ON_FAILURE)
