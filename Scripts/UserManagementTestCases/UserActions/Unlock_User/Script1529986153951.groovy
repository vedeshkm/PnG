...
WebUI.sendKeys(findTestObject('OMVA_Login_Page/Username_Textbox'), superadminID)
...
WebUI.sendKeys(findTestObject('OMVA_Login_Page/Password_Textbox'), superadminPwd)

WebUI.click(findTestObject('OMVA_Login_Page/Signin_Button'))

WebUI.delay(5)

WebUI.waitForElementVisible(findTestObject('OMVA_Landing_Page/Search_icon'), 5)

WebUI.click(findTestObject('OMVA_Landing_Page/Search_icon'))

WebUI.sendKeys(findTestObject('OMVA_Landing_Page/Search_icon'), 'Lock')
...
WebUI.verifyMatch(AHeaderTxt, findTestData('credentialDetails/PopupStrings').getValue('UnlockUserHeaderTxt', 1), true, FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyMatch(UnlockToastMsg, findTestData('credentialDetails/PopupStrings').getValue('UnlockUserToastMsg', 1), true, 
