...
WebUI.waitForElementVisible(findTestObject('OMVA_UserManagement_Page/Cancel_button_customerselectionpage'), 3)

WebUI.click(findTestObject('OMVA_UserManagement_Page/Cancel_button_customerselectionpage'))

WebUI.waitForElementVisible(findTestObject('OMVA_UserManagement_Page/Cancel_Button_Popup_HText'), 4)

WebUI.verifyElementText(findTestObject('OMVA_UserManagement_Page/Cancel_Button_Popup_HText'), 'Discard changes?', FailureHandling.STOP_ON_FAILURE)
