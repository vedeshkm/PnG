...
EmailId = emailidprefix.toString()
...
WebUI.waitForElementVisible(findTestObject('OMVA_EditUser_Page/EditUser_OkPopupButton'), 8)

WebUI.click(findTestObject('OMVA_EditUser_Page/EditUser_OkPopupButton'))

WebUI.delay(5)

WebUI.waitForElementVisible(findTestObject('OMVA_UserManagement_Page/Search_button'), 15)
...
WebUI.sendKeys(findTestObject('OMVA_UserManagement_Page/Enter_Text_Search'), EmailId)

WebUI.delay(4)

WebUI.waitForElementVisible(findTestObject('OMVA_Landing_Page/Email_grid'), 5)

emailNameText = WebUI.getText(findTestObject('OMVA_Landing_Page/Email_grid'))

WebUI.verifyMatch(EmailId + '@autotestpg.com', emailNameText, false)
