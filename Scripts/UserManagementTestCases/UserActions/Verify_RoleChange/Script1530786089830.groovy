...
WebUI.scrollToElement(findTestObject('OMVA_UserManagement_Page/DropdownOption_RoleDropdown_CategoryMSP'), 0)

WebUI.click(findTestObject('OMVA_UserManagement_Page/DropdownOption_RoleDropdown_CategoryMSP'))
...
WebUI.verifyElementText(findTestObject('OMVA_UserManagement_Page/Update_Role'), 'An email will be triggered to inform the user.')
