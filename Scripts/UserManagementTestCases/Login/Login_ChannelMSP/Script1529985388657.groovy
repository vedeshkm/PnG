...
WebUI.sendKeys(findTestObject('OMVA_Login_Page/Username_Textbox'), ChannelMSPID)

WebUI.click(findTestObject('OMVA_Login_Page/Next_Button'))

WebUI.waitForElementVisible(findTestObject('OMVA_Login_Page/Password_Textbox'), 17)

WebUI.sendKeys(findTestObject('OMVA_Login_Page/Password_Textbox'), ChannelMSPPwd)
...
WebUI.verifyMatch(greetingtext, '\\D*' + ChannelMSPID, true, FailureHandling.STOP_ON_FAILURE)
