...
WebUI.sendKeys(findTestObject('OMVA_Login_Page/Username_Textbox'), CategorylMSPID)

WebUI.click(findTestObject('OMVA_Login_Page/Next_Button'))

WebUI.waitForElementVisible(findTestObject('OMVA_Login_Page/Password_Textbox'), 10)

WebUI.sendKeys(findTestObject('OMVA_Login_Page/Password_Textbox'), CategorylMSPID)
...
WebUI.verifyMatch(greetingtext, '\\D*' + CategorylMSPID, true, FailureHandling.STOP_ON_FAILURE)
