...
WebUI.sendKeys(findTestObject('OMVA_Login_Page/Username_Textbox'), AllocSPOCID)

WebUI.click(findTestObject('OMVA_Login_Page/Next_Button'))

WebUI.waitForElementVisible(findTestObject('OMVA_Login_Page/Password_Textbox'), 10)

WebUI.sendKeys(findTestObject('OMVA_Login_Page/Password_Textbox'), AllocSPOCPwd)
...
WebUI.verifyMatch(greetingtext, '\\D*' + AllocSPOCID, true, FailureHandling.STOP_ON_FAILURE)
