...
WebUI.verifyMatch(AHeaderTxt, findTestData('credentialDetails/PopupStrings').getValue('LockedLoginHeaderTxt', 1), true, 
    FailureHandling.STOP_ON_FAILURE)

AContentTxt = WebUI.getText(findTestObject('OMVA_Login_Page/LockedLogin_ContentTxt'))

WebUI.verifyMatch(AContentTxt, findTestData('credentialDetails/PopupStrings').getValue('LockedLoginContentTxt', 1), true, 
    FailureHandling.STOP_ON_FAILURE)
