...
CustomKeywords.'applicationLibrary.ClickOnMatierial_withgivenSKUID.ClickOnSKUInprogress'(SKUID_Inprogress)
...
CustomKeywords.'applicationLibrary.ClicksOn1stBatchof_SKUID_andgetsBatchNo.ClickOnSKUInprogressBatch'(SKUID_Inprogress)
